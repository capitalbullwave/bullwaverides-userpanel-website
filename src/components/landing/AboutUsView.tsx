...
const footerLegalLinks = [
  ...
  { label: "Rider safety", href: ROUTES.safety },
  { label: "Captain terms", href: ROUTES.terms },
] as const;
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="relative overflow-hidden px-6 py-16 md:py-24 lg:py-28">
        <AnimateIn>
        <div className="pointer-events-none absolute -left-32 top-24 h-80 w-80 rounded-full bg-secondary/25 blur-3xl" />
        <div className="pointer-events-none absolute -right-20 bottom-0 h-96 w-96 rounded-[40%] bg-muted/80" />

        <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            <h1 className="font-heading text-4xl font-light leading-tight text-foreground sm:text-5xl lg:text-[3.25rem]">
              India&apos;s trusted
              <br />
              <span className="font-bold">Mobility Platform</span>
            </h1>
          ...
          <div className="relative mx-auto h-[420px] w-full max-w-md sm:h-[480px] lg:max-w-none">
            <div className="absolute right-8 top-0 h-[88%] w-[42%] rounded-[999px] bg-secondary/50" />
      ...
      <section className="relative min-h-[420px] overflow-hidden md:min-h-[480px]">
        ...
        <AnimateIn delay={0.1} className="relative flex min-h-[420px] flex-col items-center justify-center px-6 py-20 text-center md:min-h-[480px]">
          ...
          <Button
            size="lg"
            className="mt-8 h-12 rounded-full bg-foreground px-10 font-bold text-background hover:bg-foreground/90"
      ...
      <footer className="bg-foreground px-6 py-14 text-background">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
            <div>
              <p className="mb-4 text-sm font-bold text-white">Customer app</p>
            ...
            <div>
              <p className="mb-4 text-sm font-bold text-white">Captain app</p>
              <StoreBadge label="GET IT ON Google Play" />
            </div>
